...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pylibftdi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13335&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pylibftdi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pylibftdi` can be installed with:

```
conda install pylibftdi
```

It is possible to list all of the versions of `pylibftdi` available on your platform with:
